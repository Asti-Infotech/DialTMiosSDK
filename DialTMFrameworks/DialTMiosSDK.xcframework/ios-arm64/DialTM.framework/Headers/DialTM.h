...
#import <DialTM/DialTMView.h>
#import <DialTM/DialTMViewDelegate.h>
#import <DialTM/DialTMConferenceOptions.h>
#import <DialTM/DialTMLogger.h>
#import <DialTM/DialTMBaseLogHandler.h>
#import <DialTM/InfoPlistUtil.h>


@interface DialTM : NSObject
 ...
 * with those passed to DialTMView.join when joining a conference.
 */
@property (nonatomic, nullable) DialTMConferenceOptions *defaultConferenceOptions;
...
- (DialTMConferenceOptions *_Nonnull)getInitialConferenceOptions;
