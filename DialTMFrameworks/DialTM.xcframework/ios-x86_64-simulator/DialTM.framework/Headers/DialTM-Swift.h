...
#ifndef DIALTM_SWIFT_H
#define DIALTM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DialTM",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP6DialTM17JMCallKitListener_")
...
SWIFT_CLASS("_TtC6DialTM14JMCallKitProxy")
