...
#import "DialTMUserInfo.h"


@interface DialTMConferenceOptionsBuilder : NSObject
...
@property (nonatomic) BOOL isEndcallForAll;
 ...
 */
@property (nonatomic, nullable) DialTMUserInfo *userInfo;
...
@interface DialTMConferenceOptions : NSObject
...
@property (nonatomic, readonly) BOOL isEndcallForAll;

@property (nonatomic, readonly) BOOL welcomePageEnabled;

@property (nonatomic, nullable) DialTMUserInfo *userInfo;

+ (instancetype _Nonnull)fromBuilder:(void (^_Nonnull)(DialTMConferenceOptionsBuilder *_Nonnull))initBlock;
